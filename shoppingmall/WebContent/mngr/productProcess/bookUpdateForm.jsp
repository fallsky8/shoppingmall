	...
	<div id="bookUpdateForm" class="box">
		<ul>
			...
			<li><label for="publishing_date">출판일</label>
				<div id="publishing_date">
					...
					<fmt:parseNumber var="lastYear" type="number"
						value="${nowTimeStr.toString().substring(0,4) }"></fmt:parseNumber>
			...
			<li><label for="book_image">책 이미지</label> <input id="book_image"
				name="book_image" type="file">${book.book_image }
			<li><label for="book_content">내용</label> <textarea rows="13"
					cols="50" id="book_content" name="book_content"></textarea>
			<li><label for="discount_rate">할인율</label> <input
				id="discount_rate" name="discount_rate" type="text" size="5"
				maxlength="2" value="${book.discount_rate }">
			<li class="label2"><input type="submit" id="updateBook"
				value="책수정">
		</ul>
